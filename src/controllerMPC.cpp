  ...
  void iteration(const ros::TimerEvent& e)
  {
    ...
    case Automatic:
    {
      ...
      else if (m_autoState == Ready_To_Track)
      {
        ...
        {
#if TRJ == 2
          double wayPointsX[2] = {X, X + newGoalDeltaX};
          double wayPointsY[2] = {Y, Y + newGoalDeltaY};
          double wayPointsZ[2] = {Z, Z + newGoalDeltaZ};
          trj.generateTrajectory(wayPointsX, wayPointsY, wayPointsZ, 2, 1.18);
      ...
      else if (m_autoState == Tracking)
      {
        ...
        if (finalPositionError < 0.08 || trajectoryTrackTime >= trj.getEndTime())
        {
          ROS_ERROR("Trajectory track complete!");
